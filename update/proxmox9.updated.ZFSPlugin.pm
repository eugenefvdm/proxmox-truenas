...
sub properties {
    return {
        ...
        # TrueNAS iscsi (zfs type); zfs_truenas_* to avoid duplicate with native truenas: plugin
        zfs_truenas_user => {
            description => "TrueNAS API Username (zfs iscsi provider)",
            type => 'string',
        },
        zfs_truenas_password => {
            description => "TrueNAS API Password (zfs iscsi provider)",
            type => 'string',
        },
        zfs_truenas_use_ssl => {
            description => "TrueNAS API access via SSL (zfs iscsi provider)",
            type => 'boolean',
        },
        zfs_truenas_apiv4_host => {
            description => "TrueNAS API Host (zfs iscsi provider)",
            type => 'string',
        },
        zfs_truenas_apikey => {
            description => "TrueNAS API Key (zfs iscsi provider)",
            type => 'string',
        },
...
sub options {
    return {
        ...
        zfs_truenas_user => { optional => 1 },
        zfs_truenas_password => { optional => 1 },
        zfs_truenas_use_ssl => { optional => 1 },
        zfs_truenas_apiv4_host => { optional => 1 },
        zfs_truenas_apikey => { optional => 1 },
        lio_tpg => { optional => 1 },
        content => { optional => 1 },
        bwlimit => { optional => 1 },
